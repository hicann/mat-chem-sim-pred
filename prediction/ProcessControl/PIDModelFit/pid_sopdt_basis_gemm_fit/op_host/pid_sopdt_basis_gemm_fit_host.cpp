...
extern "C" void aclrtlaunch_pid_sopdt_basis_gemm_fit_kernel(
    ...
    int64_t candidates, void* workspace, uint64_t workspace_size, void* stream)
{
    return pid_basis_gemm::LaunchBasisGemmFit(
        ...
        aclrtlaunch_pid_sopdt_basis_gemm_fit_kernel);
}

extern "C" uint64_t aclnnPidSopdtBasisGemmFitGetWorkspaceSize(int64_t batch, int64_t candidates)
{
    (void)batch;
    (void)candidates;
