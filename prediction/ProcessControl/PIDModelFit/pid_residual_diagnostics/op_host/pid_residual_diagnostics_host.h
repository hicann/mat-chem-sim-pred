...
#ifndef PID_RESIDUAL_DIAGNOSTICS_HOST_H
#define PID_RESIDUAL_DIAGNOSTICS_HOST_H

#include <cstdint>

constexpr int64_t PID_RESIDUAL_DIAGNOSTICS_METRIC_COUNT = 8;
...
#endif  // PID_RESIDUAL_DIAGNOSTICS_HOST_H
