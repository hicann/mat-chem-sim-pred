...
from pid_sopdt_batch_rollout_reference import (
    RESULT_NAMES,
    make_sopdt_batch_rollout_case,
    sopdt_batch_rollout_score,
)


def test_sopdt_batch_rollout_shape_and_sanity():
    case = make_sopdt_batch_rollout_case(batch=4, candidates=8, sim_steps=64)
    results, best_idx = sopdt_batch_rollout_score(case)
...
def test_sopdt_batch_rollout_prefers_some_control_over_zero_gain():
    case = make_sopdt_batch_rollout_case(batch=1, candidates=3, sim_steps=96)
