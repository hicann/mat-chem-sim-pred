...
#ifndef PID_IPDT_BATCH_ROLLOUT_SCORE_HOST_H_
#define PID_IPDT_BATCH_ROLLOUT_SCORE_HOST_H_

#include <cstdint>

constexpr int64_t PID_IPDT_BATCH_ROLLOUT_RESULT_COUNT = 8;
...
#endif  // PID_IPDT_BATCH_ROLLOUT_SCORE_HOST_H_
