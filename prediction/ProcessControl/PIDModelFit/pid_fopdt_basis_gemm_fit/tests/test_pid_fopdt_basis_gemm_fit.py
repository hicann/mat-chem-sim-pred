...
def test_fopdt_basis_gemm_best_candidate():
    case = make_basis_gemm_case("FOPDT", batch=8, n=256, candidates=65)
...
def test_fopdt_gain_is_close_to_truth():
    case = make_basis_gemm_case("FOPDT", batch=4, n=512, candidates=97)
