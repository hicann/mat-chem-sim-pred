...
cp "$OP_ROOT/msopgen/reformer_lsh_qkv_gather_msopgen.json" "$WORK_ROOT/schema.json"
...
mv "$PROJECT/op_host/reformer_lsh_qkv_gather.cpp" \
    "$PROJECT/op_host/reformer_lsh_qkv_gather.generated.cpp.stub"
cp "$OP_ROOT/op_host/reformer_lsh_qkv_gather_host.cpp" "$PROJECT/op_host/"
cp "$OP_ROOT/op_host/reformer_lsh_qkv_gather_def.cpp" "$PROJECT/op_host/"
cp "$OP_ROOT/op_host/reformer_lsh_qkv_gather_tiling.h" "$PROJECT/op_host/"
cp "$OP_ROOT/op_kernel/reformer_lsh_qkv_gather_kernel.cpp" \
    "$PROJECT/op_kernel/reformer_lsh_qkv_gather.cpp"
...
g++ -std=c++17 -O2 "$OP_ROOT/examples/test_aclnn_reformer_lsh_qkv_gather.cpp" \
    ...
    -o "$WORK_ROOT/test_aclnn_reformer_lsh_qkv_gather"
...
LD_LIBRARY_PATH="$PROJECT/build_formal/autogen:$PROJECT/build_out/op_api/lib:${LD_LIBRARY_PATH:-}" \
    "$WORK_ROOT/test_aclnn_reformer_lsh_qkv_gather"
