...
├── simulation/               # 仿真计算方向
│   ├── AI4MD/                # 机器学习分子动力学算子
│   │   ├── Lennard_Jones/    # LJForceFused — Lennard-Jones 力场融合计算
│   │   ├── DPD/              # 耗散粒子动力学
│   │   ├── GAFF2/            # GAFF2 力场势能+力计算
│   │   ├── PME/              # Ewald 求和 + PME 加速长程静电
│   │   ├── SHAKE/            # 迭代键长约束算法
│   │   └── velocity-verlet/  # 标准 3 步时间积分器
│   └── AI4PDE/               # AI for PDE（规划中）
├── prediction/               # 预测优化方向（规划中）
└── milestone.md              # 算子开发路线图
```
