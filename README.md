...
|牛顿第三定律|F\_ij = -F\_ji，每对原子只计算一次，计算量减半|
...
|调用方式|样例代码|说明|
|-|-|-|
|aclnn接口|[test\_aclnn\_lj\_force](scientific-computing/examples/test_aclnn_lj_force.cpp)|通过 aclnnLJForce 接口调用 LJForceFused 算子|
