...
void TestSmallDeepOnet() {
    ...
    std::vector<float> hTrunkIn(querySize * trunkDim, 1.0f);
    ...
    std::cout << "DeepONet UT: max abs = " << maxVal << std::endl;
    std::cout << (maxVal > 0 ? "PASSED" : "CHECK_MANUALLY") << std::endl;
